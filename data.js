...
const DATA = {
  ...
  b2: [
    ...
    { id:'b2-sub2', type:'choice', level:'b2', category:'Subjuntiu',
      ...
      text:'El verb «dubtar» i expressions d\'incertesa (no crec que, no és cert que) van seguides de subjuntiu. Els verbs d\'afirmació (crec que, sé que) van amb indicatiu.',
    ...
    { id:'b2-sub6', type:'choice', level:'b2', category:'Subjuntiu',
      ...
      text:'«Encara que» pot anar amb indicatiu (fet real: «Encara que plou, sortiré») o amb subjuntiu (hipòtesi: «Encara que plogui, sortirem»). El subjuntiu indica que la condició no és segura.',
    ...
    { id:'b2-com4', type:'choice', level:'b2', category:'Comprensió lectora',
      ...
      text:'El to d\'un text es detecta pels mots que tria l\'autor: «sembla» indica incertesa, «ara bé» introdueix una reserva. Junts marquen una actitud cautelosa i mesurada.',
    ...
    { id:'b2-pro4', type:'choice', level:'b2', category:'Producció escrita',
      ...
      text:'Una carta o correu formal s\'obre amb una fórmula protocol·lària que estableix el tractament de vostè i indica l\'objecte de l\'escrit. S\'eviten els saludacions col·loquials.',
    ...
    { id:'b2-pro6', type:'choice', level:'b2', category:'Producció escrita',
      ...
      text:'La conclusió d\'un text formal ha de tancar el discurs de manera coherent, amb un connector de síntesi (en definitiva, per tot això) i evitar expressions col·loquials.',
    ...
    { id:'b2-lex4', type:'choice', level:'b2', category:'Lèxic formal B2',
      ...
      text:'«A nivell de» és un calc del castellà «a nivel de» molt estès però incorrecte. Les alternatives genuïnes en català formal són «quant a», «pel que fa a» o «en l\'àmbit de».',
    ...
    { id:'b2-int2', type:'choice', level:'b2', category:'Interferències',
      ...
      text:'«En base a» és un calc del castellà «en base a». La forma correcta en català és «basant-me en», «d\'acord amb» o «a partir de».',
    ...
    { id:'b2-int4', type:'choice', level:'b2', category:'Interferències',
      ...
      text:'El gerundi en català expressa accions simultànies o anteriors al verb principal. El gerundi de posterioritat (acció posterior) és incorrecte: ✗ «Va acabar, enviant l\'acta després.»',
    ...
    { id:'b2-int6', type:'choice', level:'b2', category:'Interferències',
      ...
      text:'«A pesar que» i «a pesar de» són calcs del castellà «a pesar de». En català s\'usa «malgrat que», «tot i que» o «per bé que».',
    ...
    { id:'b2-tv4', type:'choice', level:'b2', category:'Temps verbals',
      ...
      text:'El plusquamperfet (havia/havies/havia... + participi) expressa una acció acabada ABANS d\'una altra acció passada. Exemple: «Quan va arribar, ja havíem sopat.»',
    ...
    { id:'b2-prep5', type:'choice', level:'b2', category:'Preposicions',
      ...
      text:'«Des de fa» indica durada fins al present: «Treballo aquí des de fa tres anys». «Desde» (castellà) no s\'usa mai en català. Cal el «fa» per expressar la durada.',
    ...
    { id:'b2-prep7', type:'choice', level:'b2', category:'Preposicions',
      ...
      text:'«Per» indica causa, mitjà, agent o durada: «Ho fa per amor», «parla per telèfon». «Per a» indica destinatari, finalitat o termini: «un regal per a tu», «per a demà».',
    ...
    { id:'b2-cmp1', type:'choice', level:'b2', category:'Construccions comparatives',
      ...
      text:'La igualtat en català s\'expressa amb «tan + adjectiu/adverbi + com». Atenció: «igual de... que» és un calc del castellà i «tant» davant adjectiu és incorrecte.',
    ...
    { id:'b2-cmp2', type:'choice', level:'b2', category:'Construccions comparatives',
      ...
      text:'La superioritat en català s\'expressa amb «més + adjectiu/adverbi + que». «Más» és castellà i no s\'usa mai en català.',
    ...
    { id:'b2-cmp3', type:'choice', level:'b2', category:'Construccions comparatives',
      ...
      text:'Alguns adjectius tenen comparatius irregulars que cal memoritzar: bo → millor, dolent → pitjor, gran → major (o més gran), petit → menor (o més petit).',
    ...
    { id:'b2-cmp5', type:'choice', level:'b2', category:'Construccions comparatives',
      ...
      text:'El superlatiu absolut indica el grau màxim d\'una qualitat. En registre formal s\'usa el sufix -íssim/a (importantíssim) en comptes de «molt» o expressions castellanitzades.',
    ...
    { id:'b2-sub7', type:'choice', level:'b2', category:'Subjuntiu',
      ...
      text:'Alguns verbs i expressions sempre exigeixen subjuntiu a la subordinada: dubtar que, voler que, negar que, ser possible que. Amb «creure que» o «saber que» s\'usa indicatiu.',
    ...
    { id:'b2-lf7', type:'choice', level:'b2', category:'Lèxic formal B2',
      ...
      text:'En un correu professional s\'usa el tractament de vostè (li, la, el) i verbs formals com «comunicar», «informar» o «notificar». «Avisar» i «fer saber» pertanyen a registres informals.',
    ...
    { id:'b2-int7', type:'choice', level:'b2', category:'Interferències',
      question:'Quina frase és correcta en català?',
      text:'El verb «dependre» regeix la preposició «de» seguida de «si» en les oracions condicionals indirectes. Ometre «de» és un error per influència del castellà.',
    ...
    { id:'b2-ort4', type:'choice', level:'b2', category:'Ortografia B2',
      ...
      text:'La dièresi (ï, ü) indica que la vocal forma síl·laba per separat: veïna (ve-ï-na), raïm (ra-ïm). No la duen: conduir, heroïna (en -oïna la dièresi no s\'escriu per regla d\'accent).',
  ...
  c1: [
    ...
    { id:'c1-ff19', type:'fill', level:'c1', category:'Frases fetes',
      ...
      answers:['total franquesa','plena franquesa','franquesa i claredat','claredat i franquesa'],
    ...
    { id:'c1-sa9', type:'fill', level:'c1', category:'Subjuntiu avançat',
      ...
      display:'revisar — plusquamperfet de subjuntiu (1a pers. pl.)',
      answers:['hagués revisat','haguès revisat'],
