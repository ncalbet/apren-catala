...
const DATA = {
  b1: [
    ...
    { id:'b1-prep3', type:'choice', level:'b1', category:'Preposicions B1',
      ...
      options:['a la','la','per la','amb la'],
      correct:1,
      variants:[
        { text:'Ahir vaig veure ___ teva cosina pel carrer.', options:['amb la','a la','la','per la'], correct:2 },
        { text:'Cada dia acompanyo ___ filla petita a l\'escola.', options:['per la','a la','amb la','la'], correct:3 },
      ],
    ...
    { id:'b1-ort2', type:'choice', level:'b1', category:'Ortografia B1',
      ...
      options:['practica','pràctica','práctica'],
      correct:1,
      variants:[
        { text:'Demà tinc un ___ de matemàtiques molt important.', options:['exàmen','éxamen','examen'], correct:2 },
    ...
    { id:'b1-ort3', type:'choice', level:'b1', category:'Ortografia B1',
      ...
      options:['raim','raím','raïm'],
      correct:2,
      variants:[
        { text:"Aquest estiu visitarem diversos ___ d'Europa.", options:['paisos','països','paísos'], correct:1 },
  ...
  b2: [
    ...
    { id:'b2-sub5', type:'fill', level:'b2', category:'Subjuntiu',
      ...
      variants:[
        ...
        { text:'Les expressions de necessitat o obligació, com «cal que», introdueixen una subordinada en subjuntiu.', sentence:'Cal que ___ la sol·licitud amb antelació.', display:'presentar (2a pers. sing. present subj.)', answers:['presentis'] },
      ],
    ...
    { id:'b2-pro8', type:'fill', level:'b2', category:'Producció escrita',
      ...
      answers:["plau","plau d'","complau","complau d'","em complau","em complau d'"],
      theory:'«Em plau (de) + infinitiu» és la fórmula estàndard d\'obertura formal en català. Davant d\'infinitiu començat en vocal, «de» s\'apostrofa: «em plau d\'adreçar-me». Alternativa equivalent: «Em dirigeixo a vostè per...»', example:'Em plau adreçar-me a vostè per confirmar la recepció del seu escrit.' },
  ...
  c1: [
    ...
    { id:'c1-ff2', type:'fill', level:'c1', category:'Frases fetes',
      ...
      display:'verb de la locució (abandonar la lluita)', answers:['tirar','llançar','llençar'],
      variants:[
        { sentence:'Sempre intenta ___ aigua al seu molí en les negociacions.', display:'verb de la locució (actuar en interès propi)', answers:['portar','dur'],
          theory:'«Portar (o dur) aigua al seu molí» vol dir orientar un assumpte cap al propi interès. El verb forma part de la locució: no s\'hi val a dir-hi «*enviar» ni «*conduir».', example:'Cadascú intentava portar aigua al seu molí durant la negociació.' },
        { sentence:'Davant del problema, la direcció va decidir ___ cartes en l\'assumpte.', display:'verb de la locució (intervenir-hi)', answers:['prendre'],
          theory:'«Prendre cartes en un assumpte» vol dir intervenir-hi decididament. Ve del joc de cartes: qui pren cartes entra a la partida.', example:'La inspecció va prendre cartes en l\'assumpte al cap d\'una setmana.' },
      ],
      theory:'«Llançar la tovallola» significa rendir-se. Ve de la boxa, on es llança la tovallola al ring per reconèixer la derrota. El Termcat recull «llançar la tovallola» com a forma de diccionari; «tirar» hi és igualment corrent, i «llençar» també s\'admet, perquè l\'IEC tracta «llançar» i «llençar» com a intercanviables fora del sentit de desfer-se d\'una cosa.', example:'Malgrat les dificultats, no hem de llançar la tovallola ara.' },
    ...
    { id:'c1-ff11', type:'fill', level:'c1', category:'Frases fetes',
      ...
      display:'locució que significa «tenir tot el control de la situació» (en present o en passat)',
      answers:['tenia la paella pel mànec','tallava el bacallà','té la paella pel mànec','talla el bacallà'],
      variants:[
        { question:'Completa amb la locució correcta: «Després de comprar la majoria d\'accions, aquell fons ja ___ dins el consell.»', sentence:'Després de comprar la majoria d\'accions, aquell fons ja ___ dins el consell.', display:'locució que significa «tenir tot el control de la situació» (en present o en passat)', answers:['tenia la paella pel mànec','tallava el bacallà','té la paella pel mànec','talla el bacallà'] },
        { question:'Completa amb la locució correcta: «Al departament tothom sabia qui ___: era ella qui decidia de debò.»', sentence:'Al departament tothom sabia qui ___: era ella qui decidia de debò.', display:'locució que significa «tenir tot el control de la situació» (en present o en passat)', answers:['tenia la paella pel mànec','tallava el bacallà','té la paella pel mànec','talla el bacallà'] },
      ],
