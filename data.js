...
const DATA = {
  ...
  b2: [
    ...
    { id:'b2-con7', type:'fill', level:'b2', category:'Connectors',
      ...
      display:'connector concessiu/adversatiu', answers:['tot i així','tanmateix','malgrat tot'],
  ...
  c1: [
    ...
    { id:'c1-rel2', type:'fill', level:'c1', category:'Oracions de relatiu',
      ...
      display:'relatiu compost (preposició + «qual»)', answers:['en el qual','al qual'],
    ...
    { id:'c1-rel6', type:'fill', level:'c1', category:'Oracions de relatiu',
      ...
      display:'relatiu de lloc', answers:['en la qual','on','a la qual'],
