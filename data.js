...
const DATA = {
  ...
  b2: [
    ...
    { id:'b2-prep3', type:'choice', level:'b2', category:'Preposicions',
      ...
      correct:0, theory:'«Consistir en» és el règim fix. «Dependre de» (no «dependre en»). «Insistir» porta «a» davant d\'infinitiu (insistir a venir) i «en» davant de nom (insistir en la proposta).', example:'El projecte consisteix en tres etapes. / Insisteix a participar. / Insisteix en la seva postura.' },
